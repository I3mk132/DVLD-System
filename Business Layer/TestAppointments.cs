...
namespace Business_Layer
{
    public class clsTestAppointments
    {
        ...
        public static DataTable GetAllTestAppointmentsFor(int ID)
        {
            return clsTestAppointmentsDataAccess.GetAllFor(ID);
        }
        ...
        private bool _AddNew()
        {
            ...
            this.TestAppointmentID = clsTestAppointmentsDataAccess.Add(TestTypeID, LDLAppID, AppointmentDate, PaidFees, CreatedByUserID, IsLocked);
        ...
        private bool _Update()
        {
            ...
            return clsTestAppointmentsDataAccess.Update(TestAppointmentID, TestTypeID, 
                LDLAppID, AppointmentDate, PaidFees, CreatedByUserID, IsLocked);
